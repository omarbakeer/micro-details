    ...
    <>
      ...
      <Container>
        ...
        <Text paragraph>
          ...
          our team is passionate about ‘micro details’. We started this company
          so we can continue to analyze and use these details to create unique
        ...
        <MissionAndVisionContainer>
          <Wrapper>
            ...
            <TitleContainer>
              <Text secondryTitle color="white">Misson</Text>
            </TitleContainer>
            <ParagraphContainer>
              <Text paragraph>
          ...
          <Wrapper>
            ...
            <TitleContainer>
              <Text secondryTitle color ="white">Vision</Text>
            </TitleContainer>
            <ParagraphContainer>
              <Text paragraph>
                Grow into the most reliable and go-to digital and marketing
